...
namespace crudTests
{
    public class CountriesServiceTest
    {
        ...
        //previous constructor based on mocking dbcontext

        //Previous version of constructor for mocked DbContext
        //public CountriesServiceTest()
        //{
        ...
        public async Task AddCountry_DuplicateCountryName_ToBeArgumentException()
        {
            ...
            CountryAddRequest first_country_request = _fixture
                .Build<CountryAddRequest>()
                .With(temp => temp.CountryName, "Name")
                .Create();
        ...
        //When supply proper CountryName, it should insert (add) the country to the existing list of countries
        ...
        public async Task GetAllCountries_AddFewCountries_ToBeSuccessful()
        {
            ...
            List<Country> country_list = new List<Country>()
            {
                ...
                .With(temp => temp.Persons, null as IEnumerable<Person>)
                .Create(),
            ...
            //Assert
            actual_country_response_list.Should().BeEquivalentTo(country_response_list);
        }
        #endregion
        ...
        [Fact]
        //If supply null as CountryID, it should return null as CountryResponse
        ...
        [Fact]
        //If supply a valid country id, it should return the matching country details as CountryResponse object
